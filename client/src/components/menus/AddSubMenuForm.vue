...
<div class="ui container header section">
  <div>
      <h1 class="ui center aligned header text-danger">Add Submenu to Parent: {{menu.menuName}}</h1>
